...
На предыдущих этапах вы, скорее всего, уже использовали coroutines.


*если делать практические только благодаря ИИ, то корутины у вас точно будут*
![](./images/no-thanks-i-use-ai.jpg)

Теперь это становится обязательным требованием архитектуры. Все операции, связанные с сетью и хранением данных, должны выполняться **не в главном потоке**.

### 2 — Добавление оффлайн-режима

Создайте специальный класс для работы с данными - `Repository`.
...
Repository также отвечает за выбор источника данных:
